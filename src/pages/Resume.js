...
class Resume extends React.Component {
    ...
    render() {
        ...
        if (error) {
            ...
            return (
                <div className="App">
                    <div className="page mx-auto max-w-letter md:h-letter p-6 xsm:p-8 sm:p-9 md:p-16 bg-white">
                        <header className="flex items-center mb-9">
                            <div className="mr-5 text-base text-white bg-gray-700 font-medium print:bg-black px-3 py-2 leading-tight">
                        ...
                        <div className="md:col-2 print:col-2 col-gap-md md:h-letter-col print:h-letter-col col-fill">
                            <section>
                                <div className="col-break-avoid">
                                    <h2 className="mb-4 text-2sm text-gray-500 font-bold print:font-normal tracking-widest">
                                        ABOUT ME
                                    </h2>
                                        ...
                                        <header>
                                            <h3 className="text-lg text-gray-700 font-semibold leading-heading">
                                                ...
                                                >
                                                    ...
                                                    <span className="icon-parent -ml-0.5 inline-flex items-center">
                                                        <svg
                                                            className="pb-0.7 w-5 text-gray-600 group-hover:text-gray-800 transition-color-1 print:hidden "
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            viewBox="0 0 24 24"
                                                            width="24"
                                                            height="24"
