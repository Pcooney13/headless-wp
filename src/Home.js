                        ...
                        <div>
                            <div className="mt-24 mb-32 max-w-screen-lg mx-auto bg-white rounded-lg border border-black-200">
                                <div className="mx-6 flex max-w-screen-lg lg:m-auto relative overflow-hidden">
                                    ...
                                    <img
                                        className="pl-16 mt-8 relative"
                                        src={require("./dude.png")}
                                        alt={"dude"}
                                    />
                                    <p className="slide-in-left ease-out transition-all duration-300 pt-52 pl-8 font-gotham-bold text-gray-400 text-4xl">
                                        Aw{" "}
                                        <span className="text-green">snap</span>{" "}
                                        some text
                                    </p>
                                </div>
                            </div>
                                    ...
                                    <div className="w-full md:w-1/2 px-10 mb-10 md:mb-0">
                                        <div className="relative">
                                            <img
                                                ...
                                                alt=""
                                            />
                                            <div className="product border-4 border-blue absolute z-0"></div>
                                        </div>
                                    </div>
                                    <div className="w-full md:w-1/2 px-10">
                                        <div className="mb-10">
                                            ...
                                            <p className="text-sm">
                                                ...
                                                Eos, voluptatum dolorum! Laborum
                                                blanditiis consequatur,
                                                voluptates, sint enim fugiat
                                                saepe, dolor fugit, magnam
                                                explicabo eaque quas id quo
                            ...
                            <div className="w-full max-w-screen-lg rounded bg-white shadow-xl p-10 lg:p-20 mx-auto text-gray-800 relative md:text-left">
                                <div className="md:flex items-center -mx-10">
                                    <div className="w-full md:w-1/2 px-10 mb-10 md:mb-0">
                                        <div className="relative">
                                            <img
                                                src="https://pat-cooney.com/app/themes/juicy/assets/images/lime.png"
                                                className="w-full relative z-10"
                                                alt=""
                                            />
